...
import { GraduationCap, Mail, Lock, ArrowRight, User, Loader2 } from "lucide-react";
    ...
    <div className="h-full w-full bg-black text-white flex items-center justify-center p-6 bg-circuit overflow-y-auto">
      ...
      >
        <div className="flex flex-col items-center mb-6">
          <Link to="/" className="w-16 h-16 bg-gradient-to-br from-purple-400 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg shadow-purple-500/20 mb-6 transition-transform hover:scale-110">
            <GraduationCap className="text-white w-9 h-9" />
          </Link>
          <h1 className="text-3xl font-bold tracking-tight mb-2">Join StudySphere</h1>
          <p className="text-gray-400 text-sm">Join a community of ambitious students</p>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              ...
              <input 
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl py-3.5 pl-12 pr-4 outline-none focus:border-purple-500/50 focus:bg-white/10 transition-all text-sm"
              />
            </div>
          </div>
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center text-[10px] uppercase font-bold text-gray-500">
            <span className="bg-black px-3 tracking-[0.2em]">OR SIGNUP WITH</span>
          </div>
        </div>
